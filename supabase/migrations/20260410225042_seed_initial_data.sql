/*
  ...
  1. 7 seasoning products with stock levels, pricing, and descriptions
  2. Component inventory - lids, bottles, and labels
  3. Recipes for each product with ingredient weights in grams
  4. An initial empty dashboard note
*/
